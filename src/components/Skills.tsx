...
const skillCategories = [
  {
    icon: <FaCode />,
    title: "Programming",
    skills: ["Python", "C#", ".NET", "SQL", "FastAPI", "REST APIs"],
    color: "indigo",
  ...
  },
  {
    ...
    skills: ["Scikit-learn", "Keras", "PyTorch", "SHAP", "Pandas", "NumPy", "Feature Engineering", "EDA"],
    color: "violet",
  ...
  },
  {
    icon: <FaRobot />,
    title: "Generative AI",
    skills: ["LangChain", "LangGraph", "OpenAI API", "RAG", "Prompt Engineering"],
    color: "cyan",
  ...
  },
  {
    ...
    skills: ["Azure Functions", "Azure Logic Apps", "Azure API Management", "Azure Service Bus", "Azure Event Hub", "AWS Lambda", "S3", "EC2", "Bedrock"],
    color: "emerald",
  ...
  },
  {
    icon: <FaDatabase />,
    title: "Databases",
    skills: ["PostgreSQL", "MySQL", "FAISS", "Pinecone"],
    color: "amber",
  ...
  },
  {
    icon: <FaServer />,
    title: "DevOps & Tools",
    skills: ["Azure DevOps", "CI/CD Pipelines", "Git", "GitHub", "Streamlit"],
    color: "pink",
